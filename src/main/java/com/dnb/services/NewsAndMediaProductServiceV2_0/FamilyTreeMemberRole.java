...
public class FamilyTreeMemberRole  extends com.dnb.services.NewsAndMediaProductServiceV2_0.Role  implements java.io.Serializable {
    ...
    public synchronized int hashCode() {
        ...
        if (getFamilyTreeMemberRoleText() != null) {
            _hashCode += getFamilyTreeMemberRoleText().hashCode();
        }
    ...
    static {
        ...
        elemField.setFieldName("familyTreeMemberRoleText");
        elemField.setXmlName(new javax.xml.namespace.QName("", "FamilyTreeMemberRoleText"));
